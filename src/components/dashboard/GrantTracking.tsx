...
import { useActiveGrants, useGrantDeadlines } from "@/hooks/useGrantTracker";
...
export default function GrantTracking() {
  ...
  if (activeGrants === undefined || deadlines === undefined) {
    return (
  ...
  if (!activeGrants || activeGrants.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 text-muted">
        ...
        <p className="text-xs mt-1">Connect Google Sheets to track grants.</p>
      </div>
    );
  }
